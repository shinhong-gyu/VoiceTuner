...
AVoiceTunerCharacter::AVoiceTunerCharacter()
{
	...
	PointComponent = CreateDefaultSubobject<UPointComponent>(TEXT("PointComponent"));
}

void AVoiceTunerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AVoiceTunerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AVoiceTunerCharacter::Move);
...
void AVoiceTunerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AVoiceTunerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
